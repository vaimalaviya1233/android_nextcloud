...
-----END CERTIFICATE-----"""
        ...
        assertTrue(EncryptionUtilsV2().verifySignedMessage(signature, metadata, listOf(certJohn, t1cert)))
    }
...
"""
        ...
        val certJohn = EncryptionUtils.deserializeJSON(
            metadata,
            object : TypeToken<EncryptedFolderMetadataFile>() {}
        )
